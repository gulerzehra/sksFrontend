...
function BlogComp() {
  ...
  return (
    ...
    <input type="text" placeholder="Post Title" style={{ width: '300px', height: '40px', borderRadius: '10px', border: '2px solid #E5E5E5' }} />
    <p>When naming an post, be clear, concise, relevant, memorable, avoid jargon, offensive language, and check for availability and legal issues.</p>
    <div class="yatay-cizgi"></div>

    <textarea className='place' placeholder="Post..." style={{ width: '300px', height: '100px', borderRadius: '10px', border: '2px solid #E5E5E5', resize:'none' }} />
    <br></br>

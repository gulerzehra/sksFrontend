            ...
            <RegisterPageContainer>
                ...
                <div className="login-form-container">
                    <SingUpForm>
                        ...
                        id='username'
                        style={usernameIsValid ? {border: "1px solid red"} : {border: "1px solid #e0e0e0"}}
                        />
                        <label htmlFor="username">*150 characters or fewer. Use only letters, digits, and @/./+/-/_.  </label>
                        ...
                        id='email'
                        style={emailIsValid ? {border: "1px solid red"} : {border: "1px solid #e0e0e0"}}
                        />
                        ...
                        id='password'
                        style={passwordIsValid ? {border: "1px solid red"} : {border: "1px solid #e0e0e0"}}
                        />
                        <label htmlFor="">*Password requirements: Avoid similarity to personal info, 8+ characters, no common choices, no all-numeric.</label>
                        ...
                        <p>Zaten hesabın var mı? 
                            <button className='login' onClick={loginPageButton} >Login</button>
                        </p>
